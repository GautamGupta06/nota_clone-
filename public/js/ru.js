...
window._s3Lang['COOKIE_MESSAGE_SETTINGS_TEXT_V2_DEFAULT'] = "Вы сами решаете, какие куки использовать на сайте. Технические куки нужны для корректной работы и отключить их нельзя. Остальные категории вы можете включать или отключать по желанию.";
...
window._s3Lang['COOKIE_MESSAGE_TEXT_V2_DEFAULT'] = "Мы используем куки, чтобы улучшить работу сайта. Вы можете принять все cookie, отказаться от них или выбрать свои настройки.";
...
window._s3Lang['JS_EMAIL_CONFIRMATION_SENT'] = "На <b>%EMAIL%</b> было отправлено письмо с кодом подтверждения.";
...
window._s3Lang['JS_LP_LAYOUTS_MODULE_TITLE'] = "Блоки лендингов";
window._s3Lang['JS_LP_LAYOUTS_MODULE_DESCRIPTION'] = "Поиск, редактирование шаблонов, мета и настроек. Изменения синхронизируются на боевые серверы по запросу.";
window._s3Lang['JS_CHANGED_LAYOUTS_ERROR_STATE_TITLE'] = "Не удалось загрузить очередь";
window._s3Lang['TAPTOP_ONLINE_STORE_HEADER_GO_TO_DASHBOARD'] = "Перейти к панели управления";
window._s3Lang['TAPTOP_ONLINE_STORE_HEADER_BACK_TO_EDITOR'] = "Вернуться в редактор";
window._s3Lang['TAPTOP_ONLINE_STORE_HEADER_PROJECT_SETTINGS'] = "Настройки сайта";
window._s3Lang['TAPTOP_ONLINE_STORE_PRODUCT_IMAGE_NOTIFICATION'] = "На сайте будет отображаться только основное изображение";
